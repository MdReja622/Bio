...
const words = ["Web Developer", "Web Designer", "Fontend Developer"];
let wordIndex = 0;
let letterIndex = 0;
...
document.querySelector('.content').addEventListener('mouseover', () => {
    ...
    document.querySelector('.cursor').style.backgroundColor = "#c6c6c6";
    document.querySelector('.cursor').style.opacity = ".5";
